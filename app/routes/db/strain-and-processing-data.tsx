...
const soldOut = () => {
    return (
        <span
            className="inline-flex h-8 w-auto items-center rounded bg-red-100 px-2 py-0.5 text-xs text-lg font-medium font-semibold text-red-800">
      Sold Out
    </span>
    );
};
            ...
            <div className="mx-auto max-w-7xl p-4 shadow ring-black ring-opacity-25">
                ...
                <dl className="mt-5 grid grid-cols-1 divide-y divide-gray-300 overflow-hidden rounded-lg bg-gray-50 shadow md:grid-cols-3 md:divide-y-0 md:divide-x">
                    ...
                    {item.uom}
                                ...
                                <div
                                    className="text-md inline-flex items-baseline rounded-full px-2.5 py-0.5 font-medium md:mt-2 lg:mt-0">
                ...
                <div className="mt-8 flex flex-col">
                    <div className="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                            <div
                                className="max-w-screen overflow-x-auto bg-emerald-400 px-4 shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                ...
                                <table
                                    className="min-w-full divide-y divide-gray-300 rounded ring-1 ring-green-600 ring-opacity-50">
                                                            ...
                                                            <>
                                                                ...
                                                                >
                                                                    ...
                                                                    {{
                                                                            asc: (
                                                                                <span
                                                                                    className="ml-2 max-h-6 flex-none rounded bg-blue-400/60 text-gray-800 ring-1 ring-gray-500">
                                          <ChevronUpIcon
