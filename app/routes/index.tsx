...
import {Form, Link, Links, Meta, Scripts, useCatch, useTransition,} from "@remix-run/react";
            ...
            <main>
                    ...
                    <div className="mx-auto w-full">
                        <div className="relative shadow-xl sm:overflow-hidden">
                            <div className="absolute inset-0">
                                ...
                                />
                                <div
                                    className="absolute inset-0 bg-gradient-to-b from-brand-primary to-brand-primary/25"/>
                            </div>
                ...
                <div className="bg-gray-100">
                    <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8">
                        ...
                        <div
                            className="mx-auto flex grid grid-cols-2 flex-wrap justify-between gap-10 py-6 sm:grid-cols-4">
                ...
                <div className="bg-gradient-to-r from-brand-secondary/80 to-green-700">
                    <div
                        className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:px-8 lg:pt-24">
                ...
                >
                        ...
                        <div
                            ...
                            <div className="mx-auto max-w-xl px-4 sm:px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0">
                                <div>
                                    <div>
                    <span
                        className="flex h-12 w-12 items-center justify-center rounded-md bg-gradient-to-br from-green-800 to-brand-accent-light">
                      <GlobeAsiaAustraliaIcon
                    ...
                    <div className="mt-24">
                        <div
                            className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
                            <div
                                className="mx-auto max-w-xl px-4 sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
                                <div>
                                    <div>
                ...
                <div className="bg-green-200">
                    <div
                        ...
                        <h2 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                            ...
                            <span
                                className="-mb-1 block bg-gradient-to-r from-brand-secondary to-green-700 bg-clip-text pb-1 text-transparent">
                Get in touch!
              </span>
                        </h2>
