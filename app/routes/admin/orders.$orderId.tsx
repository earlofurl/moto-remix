        ...
        <div className="flex h-screen overflow-hidden">
                ...
                <div className="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden bg-white">
                    <div className="lg:relative lg:flex">
                        ...
                        <div>
                            <div
                                className="no-scrollbar border-t border-slate-200 bg-slate-50 lg:sticky lg:top-16 lg:h-[calc(100vh-64px)] lg:w-[390px] lg:shrink-0 lg:overflow-y-auto lg:overflow-x-hidden lg:border-t-0 lg:border-l">
