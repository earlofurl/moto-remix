...
import {CheckIcon, ChevronUpDownIcon, CubeIcon, XMarkIcon,} from "@heroicons/react/24/outline";
import type {Item, PackageTag, Uom} from "@prisma/client";
import type {ActionFunction, LoaderFunction} from "@remix-run/node";
import {json, redirect} from "@remix-run/node";
import {Form, useActionData, useCatch, useLoaderData, useLocation, useNavigate, useTransition,} from "@remix-run/react";
...
export default function AddPackageSlideIn(): JSX.Element {
    ...
    const [selectedParentPackageId, setSelectedParentPackageId] = useState<string | null>(locationState.state ? locationState.state.selectedParentPackageId : null);
