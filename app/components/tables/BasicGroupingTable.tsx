...
import {RectangleGroupIcon, RectangleStackIcon,} from "@heroicons/react/20/solid";
        ...
        <div className="px-2 sm:px-3 lg:px-4">
            ...
            <div className="sm:flex sm:items-center lg:px-2">
                ...
                <Popover className="relative inline-block text-left">
                    ...
                    >
                        <Popover.Panel
                            className="z-60 absolute right-0 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
