        ...
        <Popover className="relative bg-brand-primary">
            <div className="flex items-center justify-between px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
                ...
                <div className="-my-2 -mr-2 md:hidden">
                    <Popover.Button
                        className="inline-flex items-center justify-center rounded-md bg-brand-primary p-2 text-gray-800 hover:bg-brand-accent-light/70 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-black">
                                ...
                                >
                                    <Popover.Panel
                                        ...
                                        <div
                                            ...
                                            <div
                                                className="relative grid gap-6 bg-brand-secondary/80 px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
            ...
            >
                ...
                >
                    <div
                        className="divide-y-2 divide-gray-50 rounded-lg bg-brand-primary shadow-lg ring-1 ring-black ring-opacity-5">
                        <div className="px-5 pt-5 pb-6">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="-mr-2">
                                    <Popover.Button
                                        className="inline-flex items-center justify-center rounded-md bg-brand-accent-light/80 p-2 text-gray-100 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
